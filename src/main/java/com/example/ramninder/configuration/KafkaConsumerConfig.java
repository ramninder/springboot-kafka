...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig(){
        ...
        consume.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootStrapAddress);
        consume.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        consume.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        return  consume;
    }
    @Bean
